...
namespace CasaDiAna.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260515214933_AddAlergicosLoteToModeloNutricional")]
    partial class AddAlergicosLoteToModeloNutricional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.ModeloEtiquetaNutricional", b =>
                {
                    ...
                    b.Property<bool>("ContemAlergicos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("contem_alergicos");
