...
namespace CasaDiAna.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260612162912_AddCategoriasDespesa")]
    partial class AddCategoriasDespesa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.CategoriaDespesa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("EhFolhaPagamento")
                        .HasColumnType("boolean")
                        .HasColumnName("eh_folha_pagamento");
                    ...
                    b.HasIndex("Nome")
                        .HasDatabaseName("ix_categorias_despesa_nome");

                    b.ToTable("categorias_despesa", "financeiro");
                });
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.CodigoRecuperacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("codigos_recuperacao", "auth");
                });

            modelBuilder.Entity("CasaDiAna.Domain.Entities.ConfiguracaoPrecificacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("CmvAlvo")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)")
                        .HasColumnName("cmv_alvo");

                    b.Property<decimal>("MargemDesejada")
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)")
                        .HasColumnName("margem_desejada");
                    ...
                    b.ToTable("configuracao_precificacao", "financeiro");
                });

            modelBuilder.Entity("CasaDiAna.Domain.Entities.Despesa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CategoriaDespesaId")
                        .HasDatabaseName("ix_despesas_categoria_despesa_id");

                    b.HasIndex("Competencia")
                        .HasDatabaseName("ix_despesas_competencia");

                    b.ToTable("despesas", "financeiro");
                });
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.EntradaMercadoria", b =>
                {
                    ...
                    b.HasIndex("DataVencimentoBoleto")
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.FaturamentoMensal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("ValorManual")
                        .HasPrecision(15, 2)
                        .HasColumnType("numeric(15,2)")
                        .HasColumnName("valor_manual");

                    b.HasKey("Id");

                    b.HasIndex("Competencia")
                        .IsUnique()
                        .HasDatabaseName("ix_faturamentos_mensais_competencia");

                    b.ToTable("faturamentos_mensais", "financeiro");
                });
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.Ingrediente", b =>
                {
                    ...
                    b.Property<decimal?>("QuantidadeEmbalagemValor")
                        .HasPrecision(15, 4)
                        .HasColumnType("numeric(15,4)")
                        .HasColumnName("quantidade_embalagem_valor");

                    b.Property<string>("UnidadeEmbalagem")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("unidade_embalagem");
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.ModeloEtiquetaNutricional", b =>
                {
                    ...
                    b.Property<string>("AlergicoAlimentar")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("alergico_alimentar");
                    ...
                    b.Property<bool>("ContemGluten")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("contem_gluten");

                    b.Property<bool>("ContemLactose")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("contem_lactose");
                    ...
                    b.Property<string>("LoteFabricacao")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("lote_fabricacao");
                    ...
                    b.Property<string>("VdAcucaresAdicionados")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_acucares_adicionados");

                    b.Property<string>("VdCarboidratos")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_carboidratos");

                    b.Property<string>("VdFibraAlimentar")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_fibra_alimentar");

                    b.Property<string>("VdGordurasSaturadas")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_gorduras_saturadas");

                    b.Property<string>("VdGordurasTotais")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_gorduras_totais");

                    b.Property<string>("VdGordurasTrans")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_gorduras_trans");

                    b.Property<string>("VdProteinas")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_proteinas");

                    b.Property<string>("VdSodio")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_sodio");

                    b.Property<string>("VdValorEnergetico")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("vd_valor_energetico");
            ...
            modelBuilder.Entity("CasaDiAna.Domain.Entities.Despesa", b =>
                {
                    b.HasOne("CasaDiAna.Domain.Entities.CategoriaDespesa", "Categoria")
                        .WithMany()
